...
ros::Time Tdump_begin[teensy_num], Tdump_end[teensy_num];
bool Tready_flag[teensy_num], Tfinished_flag[teensy_num];
bool all_ready, count_done, count_started;
int64_t id=2;
ros::Duration Tdump_duration[teensy_num], Odump_duration;
ros::Duration count_duration;
ros::Duration timeout(5.0);

int count[teensy_num];
float Osecs, count_secs;
